...
export const demoLocations = [
  ...
  },
  {
    ...
    records:[
      record('import-r15a','import-qiming',{workDate:'2026-09-11',endDate:'2026-09-11',startDaySlot:'全天',endDaySlot:'全天',title:'啟明學校兩日施工',crew:['得','丸','斌','庭','薛','修','康'],meetingTime:'07:30',meetingPlace:'啟明學校主集合點',mapUrl:'https://maps.app.goo.gl/9fq3jAZBP9WpJsp97?g_st=ic',weather:'陰雨、豪雨，天氣不穩；準備外套及雨具。',hospitalName:'振興醫院',hospitalDistance:'2.4 公里',hospitalTravelTime:'9 分鐘',notes:'吊車預計 07:30–08:00 到場。',workDetails:'依兩日施工時程推進；雨勢過大時停止高空作業。',assignments:'得、丸、斌攜帶攀樹器材；庭、薛、修、康支援地面及現場分工。',crane:'07:30–08:00 之間進場。',parking:'開車且需卸裝備者先至 https://maps.app.goo.gl/cTHw5vztCXA5wyJR7?g_st=ic，07:00 卸裝備後回主定位點停車；機車直接到主集合點。',equipment:'攀樹器材、外套、雨具。',safetyNotes:'豪雨或雷雨時暫停高空與吊掛作業。'}),
      record('import-r15b','import-qiming',{workDate:'2026-09-12',endDate:'2026-09-12',startDaySlot:'全天',endDaySlot:'全天',title:'啟明學校兩日施工續作',crew:['斌','鴻','橘','綺','得','修','方','誠'],meetingTime:'07:30',meetingPlace:'啟明學校主集合點',mapUrl:'https://maps.app.goo.gl/9fq3jAZBP9WpJsp97?g_st=ic',weather:'雨。',hospitalName:'振興醫院',hospitalDistance:'2.4 公里',hospitalTravelTime:'9 分鐘',notes:'持續施工；若下暴雨，先整理地面，待雨勢減弱再上樹。',workDetails:'依前次進度續作；雨勢大時轉做地面整理，雨勢轉小且裝備與人員狀況安全後再恢復攀樹。',assignments:'斌、鴻、橘、綺、得攜帶攀樹裝備；修、方、誠支援。',parking:'沿用主集合點及卸裝備動線。',equipment:'多帶幾件雨衣與替換衣褲；現場備吹風機供人員乾燥使用。',safetyNotes:'避免濕冷與失溫；重新上樹前檢查繩索、PPE 與踩點狀況。'})
    ]
  }
];
